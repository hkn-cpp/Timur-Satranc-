...
const lesson63: GuidedLesson = {
  ...
  startPosition: {
    ...
    pieces: [
      ...
      { square: sq(10, 1), side: 'white', kind: PieceKind.AdventurousKing },
    ],
  },
  stagingNote: 'v3: Maceracı Şah kendi hisarına girip kilitler.',
  orientation: 'white',
  xp: 360,
  steps: [
    ...
    { kind: 'awaitMove', accept: [{ from: sq(10, 1), to: 111 }], text: 'Maceracı Şah ile hisara gir.' },
    { kind: 'show', text: 'Mühür vuruldu, sığınak kapandı.', annotate: [{ kind: 'seal', square: 111, label: 'Kilitli' }] },
    { kind: 'quiz', question: 'Kendi hisarına kim girer?', options: ['Maceracı Şah', 'Şah'], correctIndex: 0, explanation: 'Yalnızca Maceracı Şah kendi hisarına girer.' },
