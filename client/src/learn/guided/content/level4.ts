...
const lesson44: GuidedLesson = {
  ...
  startPosition: {
    ...
    pieces: [
      ...
      { square: sq(5, 2), side: 'black', kind: PieceKind.Pawn, pawnOf: PieceKind.Rook },
    ],
  },
  stagingNote: 'v3: Şehzade royal kümesinde; çifte koruma askıda oynanır.',
  orientation: 'white',
  xp: 200,
  steps: [
    ...
    { kind: 'awaitMove', accept: [{ from: sq(6, 1), to: sq(5, 2) }], text: 'Şehzade ile çaprazdaki Piyadeyi al.' },
    ...
    { kind: 'awaitSquare', accept: [WK], text: 'Şahın karesine dokun.' },
